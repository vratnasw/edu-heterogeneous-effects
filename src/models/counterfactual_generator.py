"""Gradient search for minimum-norm phase-boundary-crossing interventions.

STATUS: Phase A scaffold. Implementation pending (Phase B).
Reads from:
  - processed/joined/master_panel.parquet
  - ../edu-causal-rl/results/interventional/anchor_effects.json
Outputs: results/counterfactual/min_norm_interventions.json
"""
